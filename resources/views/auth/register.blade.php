...
<div class="container">
    <div class="row justify-content-center">
        ...
        <img src="{{ URL('img/registro.png') }}" style="width: 10%;"  alt="" height="40"></a>
                </div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="phone" type="phone" class="form-control @error('phone') is-invalid @enderror" name="phone" value="{{ old('phone') }}" required autocomplete="phone" placeholder="0974125630">

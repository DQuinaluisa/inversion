    ...
    <div id="app">
                        ...
                        @else
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                                    <a class="dropdown-item" href="{{ url('/create') }}" >Perfil</a>
                                    @can('admin')
                                    <a class="dropdown-item" href="{{ route('admin') }}" >Registrados en la Pagina</a>
                                     @endcan
                                     @can('admin')
                                     <a class="dropdown-item" href="{{ route('list') }}" >Pendientes de Pago</a>
                                      @endcan
        ...
        <footer class="bg-dark text-center text-white">
            ...
            <div class="text-center p-3" style="background-color: rgba(0, 0, 0, 0.2);">
              © 2022 Copyright:
              <a class="text-white" >Todos los derechos son reservados Money Goals</a>
            </div>
            <!-- Copyright -->
          </footer>
    </div>
